...
setup(name='docassemble.MLHformsindex',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/MLHformsindex/', package='docassemble.MLHformsindex'),
     )
